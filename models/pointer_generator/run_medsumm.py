...
This script has been converted from the original used for the "Get to the Point" paper so that
it may be implemend for the summarization of consumer health answers
"""
...
# If decode is true and single_pass is true, define whether to use original rouge evaluation code, or
# write data for later answer summ evaluation
tf.app.flags.DEFINE_string('eval_type', 'medsumm', 'must be medsumm or cnn')
tf.app.flags.DEFINE_string('generated_data_file', '/data/saveryme/asumm/asumm_data/generated_data.json', 'json path for genearted data and reference summaries')
...
def main(unused_argv):
  ...
  batcher = Batcher(FLAGS.data_path, vocab, hps, single_pass=FLAGS.single_pass, medsumm=FLAGS.medsumm, question_driven=FLAGS.question_driven, tag_sentences=FLAGS.tag_sentences)
