...
#training_data=/data/saveryme/asumm/asumm_data/training_data/bioasq_abs2summ_binary_sent_classification_training.json
...
#--tokenizer_path=/data/saveryme/asumm/models/sentence_classifier/${exp_name}/tokenizer \
