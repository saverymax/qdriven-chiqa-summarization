...
training_data=bioasq_abs2summ_binary_sent_classification_training.json
max_sent=200
binary_model=True
# Note that for first run the sub-word tokenizer has to be trained first.
...
python run_classifier.py \
    ...
    --mode=train \
    --data_path=/data/saveryme/asumm/asumm_data/training_data/${training_data} \
